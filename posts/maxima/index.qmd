...
categories: [code,analysis,maxima]
---
...
Além disso o máxima possui uma [interface online](http://www.dma.ufv.br/maxima/index.php) hospedado nos servidores do Departamento de Matemática da Universidade Federal de Viçosa.
...
[Manuais do Maxima](https://maxima.sourceforge.io/pt/documentation.html) | Página Oficial do Máxima

[Manual não Oficial do Máxima](http://www.professores.im-uff.mat.br/hjbortol/disciplinas/2006.2/esp00000/arquivos/maxima_pt.pdf) | UFF

[Apostila de Máxima](https://www.ufsm.br/app/uploads/sites/783/2020/02/apostila_software_wxmaxima.pdf) | Grupo PET Matemática da UFSM
